...
- Status sprint aktif: `IN PROGRESS` (4/9) — R-001, R-002, R-003, R-004 done
- Task selesai: **4 / 106**
- Task berjalan: — (tidak ada; berikutnya R-005 — Clock abstraction)
- Blocked: — (tidak ada)
...
| Sprint | Milestone | Status | Tasks done |
|--------|-----------|--------|-----------|
| 01 | M0 — Repository / Architecture | `IN PROGRESS` | 4 / 9 |
