...
- Status sprint aktif: `IN PROGRESS` (5/9) — R-001..R-005 done
- Task selesai: **5 / 106**
- Task berjalan: — (tidak ada; berikutnya R-006 — Seeded RNG utility)
- Blocked: — (tidak ada)
...
| Sprint | Milestone | Status | Tasks done |
|--------|-----------|--------|-----------|
| 01 | M0 — Repository / Architecture | `IN PROGRESS` | 5 / 9 |
